        ...
        $searchText
            ...
            .sink { (_) in
                ...
                self.searchedRoute = routeDict.filter({
                    ...
                    $0.value.dest_tc.contains(searchField) || $0.value.dest_sc.contains(searchField) || $0.value.dest_en.contains(searchField.uppercased()) ||
                    $0.value.orig_tc.contains(searchField) || $0.value.orig_sc.contains(searchField) || $0.value.orig_en.contains(searchField.uppercased())
                }).map{$0.value}
